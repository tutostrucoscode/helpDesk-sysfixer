...
const Login = () => {
  ...
  return (
    <div className="h-full shrink-0 flex flex-col flex-auto jSOoxX">
      <div className="jwBcHh lbJlVr flex flex-initial flex-col items-center">
        <LifeBuoy
          className="w-20 h-20 text-silver_low shrink-0	mb-9"
          aria-hidden="true"
        />
        <div className="opacity-100 eVXLHu">
          <div className="flex flex-col items-center justify-center iAScsE">
            <span className="mb-8 ehUqei">Log in en SysFixer</span>

            <button className="hUgkGA jIDgHF" onClick={() => handleLogin()}>
              <svg
                width="18"
                height="18"
                viewBox="0 0 18 18"
                className="sc-hznrA-D cEslws"
              >
                <g fill="none">
                  <path
